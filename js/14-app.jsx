...
function App() {
  ...
  return (
    <div id="app-scroll" style={{ background:"var(--bg)", paddingBottom:"calc(70px + env(safe-area-inset-bottom))" }}>
      ...
      <div style={{ position:"fixed", left:0, right:0, bottom:"calc(6px + env(safe-area-inset-bottom, 0px))", zIndex:205, display:"flex", justifyContent:"center", padding:"0 6px", pointerEvents:"none" }}>
