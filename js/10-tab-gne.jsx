...
const GNE_PRESETS = [
  ...
  { id:"mon", name:"毎週月曜日限定", land:false, img:"tpl/mon.jpg", thumb:"tpl/mon_thumb.jpg", hideFixed:true,
    layout:{
      origin:   { x:120, y:640,  size:74,  fill:"#141414", stroke:"#ffffff", sw:6,  align:"left",   maxW:960 },
      name:     { x:600, y:800,  size:160, fill:"#141414", stroke:"#ffffff", sw:11, align:"center", maxW:990 },
      count:    { x:205, y:1508, size:1,   fill:"#141414", stroke:"#141414", sw:0,  align:"center" },
      price:    { x:620, y:1300, size:250, fill:"#e01414", stroke:"#141414", sw:12, align:"center", maxW:520 },
      plus:     { x:986, y:1360, size:1,   fill:"#e01414", stroke:"#e01414", sw:0,  align:"center" },
      yen:      { x:986, y:1360, size:1,   fill:"#141414", stroke:"#141414", sw:0,  align:"center" },
      taxLabel: { x:700, y:1565, size:1,   fill:"#141414", stroke:"#141414", sw:0,  align:"center" },
      taxPrice: { x:930, y:1565, size:62,  fill:"#e01414", stroke:"#141414", sw:4,  align:"center" },
    } },
  { id:"super", name:"SUPER均一祭", land:false, img:"tpl/super.jpg", thumb:"tpl/super_thumb.jpg", hideFixed:true,
    layout:{
      origin:   { x:80,  y:830,  size:70,  fill:"#141414", stroke:"#ffffff", sw:5,  align:"left",   maxW:1030 },
      name:     { x:600, y:1000, size:160, fill:"#141414", stroke:"#ffffff", sw:10, align:"center", maxW:1050 },
      count:    { x:290, y:1512, size:1,   fill:"#141414", stroke:"#141414", sw:0,  align:"center" },
      price:    { x:640, y:1330, size:240, fill:"#e01414", stroke:"#141414", sw:11, align:"center", maxW:640 },
      plus:     { x:1000,y:1512, size:1,   fill:"#141414", stroke:"#141414", sw:0,  align:"center" },
      yen:      { x:1000,y:1512, size:1,   fill:"#141414", stroke:"#141414", sw:0,  align:"center" },
  ...
  { id:"genpin", name:"現品限り（黄）", land:true, img:"tpl/genpin.jpg", thumb:"tpl/genpin_thumb.jpg", hideFixed:true, useOff:true,
    layout:{
      origin:   { x:110, y:470,  size:86,  fill:"#141414", stroke:"#ffffff", sw:7,  align:"left",   maxW:1480 },
      name:     { x:848, y:630,  size:170, fill:"#141414", stroke:"#ffffff", sw:12, align:"center", maxW:1500 },
      count:    { x:1000,y:790,  size:1,   fill:"#141414", stroke:"#141414", sw:0,  align:"center" },
      price:    { x:1010,y:1015, size:235, fill:"#e31414", stroke:"#141414", sw:12, align:"center", maxW:520  },
      plus:     { x:1190,y:1000, size:1,   fill:"#e31414", stroke:"#e31414", sw:0,  align:"center" },
      yen:      { x:1230,y:1120, size:1,   fill:"#141414", stroke:"#141414", sw:0,  align:"center" },
      taxLabel: { x:1430,y:940,  size:1,   fill:"#141414", stroke:"#141414", sw:0,  align:"center" },
      taxPrice: { x:1480,y:1125, size:66,  fill:"#e31414", stroke:"#141414", sw:4,  align:"center" },
      offRate:  { x:300, y:1090, size:110, fill:"#ffffff", stroke:"#141414", sw:7,  align:"center" },
    } },
];

const GNE_FIXED = { plus:"+税", yen:"円", taxLabel:"税込価格" };
const GNE_W = 1200, GNE_H = 1697;              // A4たて
const GNE_W_LAND = 1697, GNE_H_LAND = 1200;   // A4よこ
...
function gneRender(ctx, f, tpl, taxMode, font, taxRate, off, dim) {
  const CW = (dim && dim.w) || GNE_W, CH = (dim && dim.h) || GNE_H;
  ...
  for (const k in LAY) {
    ...
    const fo = { x: (fp[g + "_x"] || 0), y: (fp[g + "_y"] || 0) };   // フィールド別の位置ずらし
  ...
  if (tpl) {
    ...
    ctx.fillStyle = "rgba(255,255,255,0.55)"; ctx.fillRect(40, 40, CW - 80, CH * 0.55);
...
function GeneratorTab({ onCreatePop }) {
  ...
  const CW = land ? GNE_W_LAND : GNE_W, CH = land ? GNE_H_LAND : GNE_H;
