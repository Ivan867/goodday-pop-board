...
const GNE_PRESETS = [
  ...
  { id:"genpin", name:"現品限り（黄）", land:true, img:"tpl/genpin.jpg", thumb:"tpl/genpin_thumb.jpg", hideFixed:true, useOff:true,
    layout:{
      ...
      name:     { x:848, y:590,  size:170, fill:"#141414", stroke:"#ffffff", sw:12, align:"center", maxW:1500 },
      count:    { x:990, y:750,  size:1,   fill:"#141414", stroke:"#141414", sw:0,  align:"center" },
      price:    { x:990, y:1000, size:250, fill:"#e31414", stroke:"#141414", sw:12, align:"center", maxW:560  },
      plus:     { x:1470,y:900,  size:1,   fill:"#e31414", stroke:"#e31414", sw:0,  align:"center" },
      yen:      { x:1470,y:900,  size:1,   fill:"#141414", stroke:"#141414", sw:0,  align:"center" },
      taxLabel: { x:1470,y:930,  size:1,   fill:"#141414", stroke:"#141414", sw:0,  align:"center" },
    ...
    <div style={{ maxWidth:1600, margin:"0 auto", padding:16, animation:"fadeUp .3s ease" }}>
      ...
      <div className="gne-grid" style={{ display:"grid", gridTemplateColumns:"minmax(0, 1fr)", gap:14 }}>
        ...
        <div style={{ ...card, display:"flex", flexDirection:"column", gap:10 }}>
          ...
          {rows.length > 0 && (
            <div>
              <div style={{ fontSize:12, fontWeight:800, color:"var(--sub)", margin:"4px 0 7px" }}>
                読み込んだ商品（押すと上のプレビューに入ります）
              </div>
