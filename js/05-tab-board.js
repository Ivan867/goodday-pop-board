  ...
  const savePlan = async () => {
    ...
    try {
      const body = {
        ...
        start_date: planDate || null,
        note: planNote.trim() || null,
        author: localStorage.getItem("lastAuthor") || null
      };
      if (planEdit) await api.updatePlan(planEdit, body);else await api.addPlan({
        ...body,
        status: "todo"
      });
      setPlanTitle("");
      ...
      try {
        window.dispatchEvent(new CustomEvent("appToast", {
          detail: planEdit ? "直しました" : "予定を登録しました"
        }));
      } catch (e) {}
    } catch (e) {
      try {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      style: {
        ...
        alignItems: "center",
        gap: 7,
        marginBottom: shownPlans.length || planOpen ? 9 : 0
      }
    ...
    }, "これからの販促"), active.length > 0 && /*#__PURE__*/React.createElement("span", {
      style: {
        fontSize: 10,
        fontWeight: 900,
      ...
      style: {
        marginLeft: "auto",
        border: "none",
        background: planOpen ? "var(--chip)" : "var(--primary-soft)",
        color: planOpen ? "var(--text)" : "#fff",
        borderRadius: 8,
        padding: "5px 12px",
        fontSize: 11.5,
        fontWeight: 800,
    ...
    }, planOpen ? "とじる" : "＋ 追加")), planOpen && /*#__PURE__*/React.createElement("div", {
      style: {
        background: "var(--bg)",
        borderRadius: 9,
        padding: "10px 11px",
      ...
      onClick: savePlan,
      disabled: planBusy || !planTitle.trim(),
      style: {
        border: "none",
        background: planBusy || !planTitle.trim() ? "#ccc" : "var(--primary-soft)",
        color: "#fff",
        borderRadius: 8,
        padding: "9px 18px",
        fontSize: 13,
    ...
    }, planEdit ? "直す" : "登録")), /*#__PURE__*/React.createElement("input", {
      value: planNote,
      onChange: e => setPlanNote(e.target.value),
      placeholder: "ひとこと（例：298円予定・初物で打つ）",
      style: {
        width: "100%",
        boxSizing: "border-box",
        border: "1px solid var(--line)",
    ...
    })), shownPlans.length === 0 && !planOpen ? /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 11.5,
        color: "var(--faint)",
        lineHeight: 1.6,
    ...
    }, "会議で聞いた「来月これが入る」を登録しておくと、全店で共有できます") : /*#__PURE__*/React.createElement("div", {
      style: {
        display: "flex",
        flexDirection: "column",
        gap: 6
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        style: {
          ...
          borderRadius: 9,
          padding: "8px 10px",
          background: p.status === "done" ? "#fafbfa" : "#fff",
          opacity: p.status === "done" ? 0.75 : 1
        }
      }, /*#__PURE__*/React.createElement("div", {
        style: {
          display: "flex",
      ...
      }, p.title), dl !== null && /*#__PURE__*/React.createElement("span", {
        style: {
          fontSize: 10.5,
          fontWeight: 800,
          color: soon ? "#e0555f" : "var(--faint)",
          flexShrink: 0
        }
      }, dl > 0 ? `あと${dl}日` : dl === 0 ? "今日から" : `${-dl}日前から`), /*#__PURE__*/React.createElement("span", {
        style: {
          marginLeft: "auto",
          display: "flex",
          gap: 4,
      ...
      }, "消す"))), p.note && /*#__PURE__*/React.createElement("div", {
        style: {
          fontSize: 11.5,
          color: "var(--sub)",
          lineHeight: 1.55,
    ...
    })), doneOnes.length > 0 && /*#__PURE__*/React.createElement("button", {
      onClick: () => setPlanAllOpen(v => !v),
      style: {
        border: "none",
        background: "transparent",
        color: "var(--sub)",
