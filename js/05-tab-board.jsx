      ...
      <div style={{ maxWidth:1600, margin:"0 auto", padding:"9px 16px 185px" }}>
        ...
        <div style={{ display:"grid", gridTemplateColumns:"repeat(4, minmax(0, 1fr))", gap:7, marginBottom:9, maxWidth:520 }}>
          {[
            ...
            ["order", "発注", false, <svg key="e" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round"><rect x="4" y="3" width="16" height="18" rx="2"/><path d="M8.5 8h7M8.5 12h7M8.5 16h4"/></svg>],
