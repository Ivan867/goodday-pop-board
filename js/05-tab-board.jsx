      ...
      <div style={{ maxWidth:1600, margin:"0 auto", padding:"9px 16px 185px" }}>
        ...
        <div style={{ display:"grid", gridTemplateColumns:"repeat(5, minmax(0, 1fr))", gap:7, marginBottom:9, maxWidth:640 }}>
          {[
            ...
            ["__upload", "投稿", true, <svg key="d" width="19" height="19" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round"><path d="M12 5v14M5 12h14"/></svg>],
