...
const CAT_WORD_SETS = [{
  ...
  key: "utsuwa",
  label: "器・盛り方",
  words: ["桶", "舟", "オードブル", "姿造り", "大漁盛り", "海賊盛り"]
}, {
  key: "ninzu",
  label: "人数・量",
  words: ["2人前", "3人前", "4人前", "5人前", "6人前", "8点盛", "10点盛", "12点盛", "10貫", "18貫", "20貫", "28貫", "32貫", "40貫", "48貫", "50貫", "少人数", "大人数"]
}, {
  key: "gyoji",
  label: "行事",
  words: ["祝い鯛", "尾頭付き", "おせち", "かに", "うなぎ", "年越し", "ちらし"]
}, {
  key: "sanchi",
  label: "産地・状態",
...
const catNormalize = value => String(value == null ? "" : value).normalize("NFKC").toLocaleLowerCase("ja").replace(/\s+/g, "").trim();
...
function CatalogTab() {
  ...
  const buildImageSearchUrl = c => {
    ...
    if (mode === "easy") {
      ...
      query = [`"${storeName}"`, seasonTerm, CAT_RESERVATION_QUERY, genreTerm, extra, String(searchYear)].filter(Boolean).join(" ");
    }
    return "https://www.google.com/search?tbm=isch&q=" + encodeURIComponent(query);
  };
  ...
  const Card = ({
    ...
    const FavBtn = ({
      ...
      "aria-label": isFav ? "重点調査から外す" : "重点調査に追加",
      "aria-pressed": isFav,
      title: isFav ? "重点調査から外す" : "重点調査に追加",
      style: {
        border: "none",
    ...
    if (cview === "sm") {
      ...
      }, c.store)), /*#__PURE__*/React.createElement(SearchBtn, {
        compact: true
      }));
    }
    return /*#__PURE__*/React.createElement("div", {
    ...
    }, c.systems))), /*#__PURE__*/React.createElement(SearchBtn, null));
  };
  const selBase = {
    border: "1px solid var(--line)",
    borderRadius: 8,
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    ...
    style: selBase
  }, CAT_SEASON_OPTS.map(sn => /*#__PURE__*/React.createElement("option", {
    key: sn,
    value: sn
  }, sn)))), /*#__PURE__*/React.createElement("label", {
    style: {
      display: "block"
    }
  }, /*#__PURE__*/React.createElement("span", {
    ...
    style: selBase
  }, CAT_GENRE_OPTS.map(o => /*#__PURE__*/React.createElement("option", {
    key: o.key,
    value: o.key
...
function OrderTab() {
  ...
  const [todayChecked, setTodayChecked] = useState(() => {
    try {
      return JSON.parse(localStorage.getItem("orderDayChecked") || "{}");
    } catch (e) {
      return {};
    }
  });
  const saveTodayChecked = (dayKey, v) => {
    ...
    try {
      localStorage.setItem("orderDayChecked", JSON.stringify(next));
    } catch (e) {}
  };
  const [loading, setLoading] = useState(true);
  ...
  useEffect(() => {
    ...
    setDocsLoading(true);
    api.listResources(false).then(r => setDocs(r || [])).catch(() => setDocs([])).finally(() => setDocsLoading(false));
  }, [tab]);
    ...
    try {
      ...
      wb.SheetNames.forEach(sn => {
        ...
        [0, 3, 6].forEach(base => {
          for (let r = 0; r < grid.length; r++) {
            ...
            const rec = {
              category: sn,
              name: String(row[base + 1]).trim(),
              row: r,
              base
            };
            for (let k = 1; k <= 4; k++) {
              const rr = grid[r + k] || [];
              const lab = String(rr[base] || "").trim(),
                val = rr[base + 1];
              if (lab === "期限区分") rec.life_kind = val ? String(val).trim() : null;else if (lab === "D+") {
                const n = parseFloat(String(val).replace("５", "5"));
                rec.life_days = isNaN(n) ? null : Math.round(n);
              } else if (lab === "仕入先") rec.maker = val ? String(val).trim() : null;else if (lab === "売価") {
                const n = parseFloat(val);
                rec.price = isNaN(n) ? null : Math.round(n);
              }
            }
            found.push(rec);
            r += 4;
      ...
      try {
        ...
        for (let si = 0; si < wb.SheetNames.length; si++) {
          ...
          (drel.match(/Id="rId\d+"[^>]*Target="[^"]+"/g) || []).forEach(t => {
            const a = t.match(/Id="(rId\d+)"/),
              b = t.match(/Target="\.\.\/media\/([^"]+)"/);
          ...
          for (const blk of anchors) {
            ...
            let best = cands[0];
            cands.forEach(c => {
              if (Math.abs(c.row - row) < Math.abs(best.row - row)) best = c;
            });
      ...
      for (let i = 0; i < found.length; i++) {
        ...
        const body = {
          ...
          category: f.category,
          price: f.price ?? null,
          life_kind: f.life_kind || null,
          life_days: f.life_days ?? null,
          thumb: thumbs[f.name] || null,
          unit: "ケース"
        };
        const exist = items.find(x => x.name === f.name);
        if (exist) {
          await api.updateOrderItem(exist.id, body);
          upd++;
        } else {
  ...
  if (!unlocked) {
    ...
    }, pwErr), /*#__PURE__*/React.createElement("button", {
      onClick: tryUnlock,
      style: {
        width: "100%",
        border: "none",
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
      ...
      }, OI_WDAY[d.getDay()]), /*#__PURE__*/React.createElement("span", {
        style: {
          display: "block",
          fontSize: 16,
          fontWeight: 900,
      ...
      }, n), tod && !sel && /*#__PURE__*/React.createElement("span", {
        style: {
          position: "absolute",
          top: 3,
          right: 4,
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        onClick: () => {
          ...
          if (on) delete n[r.id];else n[r.id] = true;
          saveTodayChecked(dayKey, n);
        },
        "aria-label": on ? "まだにする" : "済みにする",
        "aria-pressed": on,
        style: {
          width: 28,
          height: 28,
      ...
      }))), r.thumb ? /*#__PURE__*/React.createElement("img", {
        src: r.thumb,
        alt: "",
        style: {
          width: 48,
        ...
        value: r[keyOf] == null ? "" : String(r[keyOf]),
    ...
    const tapItem = async it => {
      ...
      if (row) {
        await setCell(row, dk, it.qty != null ? String(it.qty) : "1");
        return;
      }
      // 行がなければ作ってから入れる
      setSheetBusy(true);
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
      ...
      const d = new Date(wkStart);
      d.setDate(d.getDate() + (dnum === 0 ? 6 : dnum - 1));
      return /*#__PURE__*/React.createElement("button", {
        key: dnum,
        onClick: () => setSheetDay(dnum),
        style: {
          flex: 1,
          border: sel ? "none" : "1px solid var(--line)",
          background: sel ? "var(--primary)" : "#fff",
    ...
    }, onDay.map(r => /*#__PURE__*/React.createElement("div", {
      key: r.id,
      style: {
        display: "flex",
        alignItems: "center",
      ...
      const on = openCat === c;
      const n = active.filter(it => (it.category || "その他") === c && rows.some(r => r.item_id === it.id && r[dk] != null && r[dk] !== "")).length;
      return /*#__PURE__*/React.createElement("button", {
        key: c,
      ...
      }, [it.maker, it.life_days != null ? `D+${it.life_days}` : null].filter(Boolean).join(" ／ "))), it.price != null && /*#__PURE__*/React.createElement("span", {
        style: {
          fontSize: 12,
          fontWeight: 900,
    ...
    }, r.title), /*#__PURE__*/React.createElement("svg", {
      width: "17",
      height: "17",
      viewBox: "0 0 24 24",
      fill: "none",
  ...
  }))) : tab === "cal" ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      alignItems: "center",
      gap: 8,
  ...
  }, OI_WDAY.map((w, i) => /*#__PURE__*/React.createElement("div", {
    key: w,
    style: {
      textAlign: "center",
      fontSize: 11.5,
    ...
    return /*#__PURE__*/React.createElement("button", {
      ...
      style: {
        aspectRatio: "1",
        border: isPicked ? "2px solid var(--primary-soft)" : isToday ? "1.5px solid #e0a020" : "1px solid var(--line)",
        background: bg,
        borderRadius: 8,
        padding: 2,
        cursor: "pointer",
    ...
    return dayLogs.length === 0 ? /*#__PURE__*/React.createElement("div", {
      ...
      }, it ? it.name : "（削除済み）"), l.qty != null && /*#__PURE__*/React.createElement("span", {
        style: {
          fontSize: 12.5,
          fontWeight: 900,
          color: "var(--primary-soft)",
    ...
    value: logQty[it.id] ?? "",
    onChange: e => setLogQty(v => ({
      ...v,
      [it.id]: e.target.value.replace(/[^0-9.]/g, "")
    })),
    inputMode: "decimal",
    placeholder: it.qty != null ? String(it.qty) : "数量",
    style: {
      width: 64,
      flexShrink: 0,
      boxSizing: "border-box",
  ...
  }, it.unit || ""), /*#__PURE__*/React.createElement("button", {
    onClick: () => addLog(it),
    disabled: busy,
    style: {
      border: "none",
  ...
  }, msg))) : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 8,
      marginBottom: 12
  ...
  }, busy ? "保存中…" : editId ? "直す" : "登録する"))), (() => {
    const off = items.filter(i => i.active === false);
    return off.length > 0 ? /*#__PURE__*/React.createElement("div", {
      style: {
        marginBottom: 12
      }
    }, /*#__PURE__*/React.createElement("button", {
    ...
    }, off.map(it => /*#__PURE__*/React.createElement("div", {
      key: it.id,
      style: {
        display: "flex",
        alignItems: "center",
...
function BundleTab() {
  ...
  const savePrompt = async () => {
    ...
    try {
      await api.addBundlePrompt({
        bundle_id: openId,
        title: pForm.title.trim() || null,
        prompt: pForm.prompt.trim(),
  ...
  if (inner && cur) {
    ...
    return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    ...
    }, [["pop", `POP（${items.length}）`], ["prompt", `プロンプト（${prompts.length}）`]].map(([k, l]) => /*#__PURE__*/React.createElement("button", {
      key: k,
      onClick: () => setTab(k),
      style: {
        flex: 1,
      ...
      style: {
        width: "100%",
        border: "none",
        background: addOpen ? "var(--chip)" : "var(--primary-soft)",
        color: addOpen ? "var(--text)" : "#fff",
        borderRadius: 10,
        padding: "11px",
        fontSize: 13.5,
        fontWeight: 800,
    ...
    }, cands.slice(0, 60).map(p => /*#__PURE__*/React.createElement("button", {
      key: p.id,
      onClick: () => addPop(p),
      disabled: busy,
      style: {
      ...
      style: {
        width: "100%",
        border: "none",
        background: pOpen ? "var(--chip)" : "var(--primary-soft)",
        color: pOpen ? "var(--text)" : "#fff",
        borderRadius: 10,
        padding: "11px",
        fontSize: 13.5,
        fontWeight: 800,
      ...
      onClick: savePrompt,
      disabled: busy || !pForm.prompt.trim(),
      style: {
        width: "100%",
        border: "none",
        background: busy || !pForm.prompt.trim() ? "#ccc" : "var(--primary-soft)",
        color: "#fff",
        borderRadius: 9,
        padding: "11px",
        fontSize: 13,
    ...
    }, pr.title || "（名前なし）"), /*#__PURE__*/React.createElement("button", {
      onClick: () => copyPrompt(pr),
      style: {
        border: "none",
        background: copied === pr.id ? "#3f9e63" : "var(--primary-soft)",
        color: "#fff",
        borderRadius: 7,
        padding: "5px 12px",
        fontSize: 12,
    ...
    }, pr.prompt)))))), sel && /*#__PURE__*/React.createElement(PopDetail, {
      pop: sel,
      onClose: () => setSel(null),
      onDelete: () => {
        setSel(null);
